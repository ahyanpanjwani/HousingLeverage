    ...
    void dataWriter(ArrayList<double[]> outputMatrix, String destinationFilePath){
        ...
        try(FileWriter fileWriter = new FileWriter(destinationFilePath)){
            String[] header = { "age", "value", "current_asset", "current_quantity",
                                "current_mortgage_rate", "current_origination_ltv", "fico_score", "current_ltv",
                                "wage", "consumption", "future_asset", "future_quantity", "new_mortgage_rate",
                                "new_origination_ltv", "status", "average_bequest"};
            for (String s : header) {
                fileWriter.append(s);
                fileWriter.append(",");
            }
