...
public class StochasticCSRealistic {
    ...
    public static void main(String args[]){
        ...
        // Use these paths for cluster runs
        // String defaultRatesPath = "/home/ap2272/project/CreditSurface/DefaultRates.csv";
        // String prepayRatesPath = "/home/ap2272/project/CreditSurface/PrepayRates.csv";

        // Use these paths for local runs
        ...
        // use the following for cluster runs
        // String outputFile = "/home/ap2272/project/CreditSurface/";
        // use this for local runs
        String outputFile = "DataWork/LeverageCycle/StochCSRealistic" + String.valueOf(H_0) + ".csv";

        try(FileWriter fileWriter = new FileWriter(outputFile + "StochCSRealistic" + String.valueOf(H_0) + ".csv")){
            for (int f = 0; f < FICO.length; f++){
                for (int l = 0; l < OLTV_interpolated.length; l++){
